...
import edu.nuzp.proupernutrition.databinding.ActivityMainCountryBinding;

public class MainActivityCountry extends AppCompatActivity {

    private AppBarConfiguration appBarConfiguration;
    private ActivityMainCountryBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityMainCountryBinding.inflate(getLayoutInflater());
